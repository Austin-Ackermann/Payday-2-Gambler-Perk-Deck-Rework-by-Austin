...
--             if player_manager:has_category_upgrade("player", "gambler_dodge_perk") then
...
--     chance = change + self.gambler_lucky_dodge_stacks/100 + self.gambler_dodge_difference / 100
